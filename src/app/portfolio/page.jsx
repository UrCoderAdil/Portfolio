  ...
  return (
    ...
    >
      <div className="h-[600vh] relative" ref={ref}>
        <div className="w-screen h-[calc(100vh-6rem)] flex items-center justify-center text-8xl text-center dark:text-gray-400 dark:text-shadow-black dark:shadow-2xl">
          My Works
        </div>
            ...
            {items.map((item) => (
              ...
              >
                <div className="flex flex-col items-center gap-2 text-white max-w-xl px-6 text-center">
                  {/* Title */}
                  <h1 className="text-xl font-bold md:text-2xl lg:text-3xl xl:text-4xl dark:text-gray-100">
                    {item.title}
                  </h1>
                  ...
                  {/* Description */}
                  <p className="w-80 md:w-96 lg:w-[500px] lg:text-lg xl:w-[600px] dark:text-gray-100">
                    {item.desc}
                  </p>
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
        <h1 className="text-8xl dark:text-gray-100">Do you have a project?</h1>
        <div className="relative">
          ...
          >
            ...
            <text fill="currentColor" className="text-black dark:text-gray-400">
          ...
          <Link
            href="/contact"
            className="w-16 h-16 md:w-28 md:h-28 absolute top-0 left-0 right-0 bottom-0 m-auto bg-black text-white rounded-full flex items-center justify-center font-bold hover:text-gray-400 hover:text-black transition hover:text-2xl dark:text-gray-400"
          >
            Hire Me
          </Link>
        </div>
